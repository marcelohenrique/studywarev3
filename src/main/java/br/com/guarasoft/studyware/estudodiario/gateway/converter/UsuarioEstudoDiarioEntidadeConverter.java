...
public class UsuarioEstudoDiarioEntidadeConverter {
	...
	public List<UsuarioEstudoDiarioBean> convert(UsuarioEstudoBean beanPai, Set<UsuarioEstudoDiario> entidades) {
	...
	public Set<UsuarioEstudoDiario> convert(UsuarioEstudo entidadePai, List<UsuarioEstudoDiarioBean> beans) {
